...
<body>
    <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <li class="nav-item">
                <a class="nav-link" href="list_emp.php" style="color:white;">View Admin <span class="badge badge-pill" style="background-color:#2196f3;"><?php include('count_emp.php');?></span></a>
            </li>
            <li class="nav-item">
    ...
    <div class="mycontainer table-responsive">
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                        ...
                        <?php
                                global $row;
                                $query = mysqli_query($conn,"SELECT * FROM leavefor");
                                         ...
                                         $cnt=1;
                                          ...
                                          while($row = mysqli_fetch_assoc($query)){
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td style='display:flex'><a href=\"updateStatusAccept.php?id={$row['id']}&absence={$row['absence']}\"><button class='btn-success btn-sm' >Accept</button></a>
                                                    <a href=\"updateStatusReject.php?id={$row['id']}&absence={$row['absence']}\"><button class='btn-danger btn-sm' >Reject</button></a></td>
                                                  </tr>";  
                                         $cnt++; }       
                                    }
                                }
                                else{
                                    echo "Query Error : " . "SELECT * FROM leavefor WHERE status='Pending'" . "<br>" . mysqli_error($conn);
                                }
                       ?> 
