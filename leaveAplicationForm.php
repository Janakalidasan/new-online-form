...
<?php 
  $reasonErr = $absenceErr = $userErr = "";
  global $leaveApplicationValidate;
  if(isset($_POST['submit'])){
    if(empty($_POST['username'])){
      $userErr = "Please entername";
    ...
    if($leaveApplicationValidate){
      ...
      $eid_query = mysqli_query($conn,"SELECT id FROM signup WHERE username='".$username."'");
      
      $row = mysqli_fetch_array($eid_query);
      
      $query = "INSERT INTO leavefor(username,absence,fromdate, todate,status) VALUES('$username','$absencePlusReason', '$fromdate', '$todate', '$status')";
...
<body>
  ...
  <br>
      ...
      <input type="submit" name="submit" value="Submit Leave Request" class="btn sls">
    </form>
